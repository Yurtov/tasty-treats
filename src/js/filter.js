...
const resetBtn = document.querySelector('.btn-rst');
...
function clearFilters() {
  searchInputEl.value = '';
  timeSelectorEl.value = 5;
  areaSelectorEl.value = 'Ukrainian';
  ingredientSelectorEl.value = '640c2dd963a319ea671e3668';
...
searchInputEl.addEventListener(
  'input',
  _.debounce(searchInputChangeHandler, 300)
);
